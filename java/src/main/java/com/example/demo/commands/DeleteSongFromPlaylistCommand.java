...
public class DeleteSongFromPlaylistCommand implements ICommand{
    ...
    public void invoke(List<String> tokens) {
        ...
        Playlist p = playlistService.deleteSong(name, songid);
        ...
        songs.deleteCharAt(songs.length()-1);     ///// to remove last space
        songs.deleteCharAt(songs.length()-1);      //// to remove last ,
        songs.append("]");
